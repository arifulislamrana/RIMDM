              ...
              <form action="{{Route('notices.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body row">
                    <div class="form-group col-md-10">
                        <label for="exampleInputName1">Notice Heading</label>
                        <input type="text" class="form-control" placeholder="Enter Subject Name" name="heading" value="{{old('heading')}}" required>
                    </div>
                    <div class="form-group col-md-10">
                        <label for="exampleFormControlTextarea1" >Noitce Description</label>
