        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <form action="{{Route('classLevels.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body row">
                    <div class="form-group col-md-6">
                        <label for="exampleInputName1">Class Name</label>
                        <input type="text" class="form-control" placeholder="Enter Class Name" name="name" value="{{old('name')}}" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="exampleInputName1">Section</label>
                        <input type="text" class="form-control" placeholder="Enter Section Name" name="section" value="{{old('section')}}">
                    </div>
                </div>
                <!-- /.card-body -->
