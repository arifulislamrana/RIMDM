        ...
        <div class="container">
            <div class="row mx-m-25">
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="/front/images/3.jpg" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="/front/images/4.jpg" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="/front/images/5.jpg" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                ...
                <div class="col-12 col-md-6 col-lg-4 px-25">
                    <div class="course-content">
                        <figure class="course-thumbnail">
                            <a href="#"><img src="/front/images/6.jpg" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="featured-event-content">
                        <figure class="event-thumbnail position-relative m-0">
                            <a href="#"><img src="/front/images/event-1.jpg" alt=""></a>
                ...
                <div class="col-12 col-lg-6 mt-5 mt-lg-0">
                    <div class="event-content flex flex-wrap justify-content-between align-content-stretch">
                        <figure class="event-thumbnail">
                            <a href="#"><img src="/front/images/event-2.jpg" alt=""></a>
                        </figure><!-- .course-thumbnail -->
                    ...
                    <div class="event-content flex flex-wrap justify-content-between align-content-lg-stretch">
                        <figure class="event-thumbnail">
                            <a href="#"><img src="/front/images/event-3.jpg" alt=""></a>
                        </figure><!-- .course-thumbnail -->
