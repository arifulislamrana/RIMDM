    ...
    <div class="container">
      <div class="row justify-content-center fullscreen align-items-center">
        ...
        <div class="offset-lg-2 col-lg-5 col-md-12 home-banner-right">
          <img class="img-fluid" src="{{ asset('front/img/header-img.png') }}" alt="" />
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container-fluid">
      ...
      <div class="owl-carousel popuar-course-carusel">
        <div class="single-popular-course">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="{{ asset('front/img/popular-course/p1.jpg') }}" alt="" />
          </div>
          <div class="details">
        ...
        <div class="single-popular-course">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="{{ asset('front/img/popular-course/p2.jpg') }}" alt="" />
          </div>
          <div class="details">
            <div class="d-flex justify-content-between mb-20">
              <p class="name">programming language</p>
        ...
        <div class="single-popular-course">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="{{ asset('front/img/popular-course/p3.jpg') }}" alt="" />
          </div>
          <div class="details">
            <div class="d-flex justify-content-between mb-20">
              <p class="name">programming language</p>
        ...
        <div class="single-popular-course">
          <div class="thumb">
            <img class="f-img img-fluid mx-auto" src="{{ asset('front/img/popular-course/p4.jpg') }}" alt="" />
          </div>
          <div class="details">
            <div class="d-flex justify-content-between mb-20">
              <p class="name">programming language</p>
          ...
          <div class="owl-carousel video-carousel">
            <div class="single-video">
              <div class="video-part">
                <img class="img-fluid" src="{{ asset('front/img/video-img.jpg') }}" alt="">
                <div class="overlay"></div>
                <a class="popup-youtube play-btn" href="https://www.youtube.com/watch?v=VufDd-QL1c0">
                  <img class="play-icon" src="{{ asset('front/img/play-btn.png') }}" alt="">
                </a>
              </div>
      ...
      <div class="testi-slider owl-carousel" data-slider-id="1">
        <div class="row align-items-center">
          <div class="col-lg-5">
            <div class="item">
              <div class="testi-item">
                <img src="{{ asset('front/img/quote.png') }}" alt="" />
          ...
          <div class="offset-lg-1 col-lg-6">
            <img src="{{ asset('front/img/testimonial/t1.jpg') }}" alt="" />
          </div>
        </div>
      ...
      <div class="feature-inner row">
        ...
        <div class="col-lg-4 col-md-6">
          <div class="single-blog-post">
            <img src="{{ asset('front/img/blog-post/b1.jpg') }}" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
        ...
        <div class="col-lg-4 col-md-6 mt--160">
          <div class="single-blog-post">
            <img src="{{ asset('front/img/blog-post/b2.jpg') }}" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
        ...
        <div class="col-lg-4 col-md-6 mt--260">
          <div class="single-blog-post">
            <img src="{{ asset('front/img/blog-post/b3.jpg') }}" class="img-fluid" alt="" />
            <div class="overlay"></div>
            <div class="top-text">
              <p>29th, oct, 2018</p>
              <p>121 likes</p>
